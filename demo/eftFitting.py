...
params += ['--pretrained_checkpoint', 'eft_model_zoo/cocoall_h36m_mpiinf_posetrack_lsptrain_ochuman.pt',
           '--num_workers', '0', '--noEval']  # A strong model

params += ['--batch_size', '1']  # only one sample for EFT

# Choose DB
params += ['--db_set', 'dance_0420']  # target DB to run EFT fitting. DB names are defined in ./eft/cores/config.py
